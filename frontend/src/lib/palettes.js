...
export const PALETTES = [
  ...
  },
  {
    ...
    // 2026-07-09 — Bumped light.primary from #8B5CF6 → #7C3AED so
    // white text on a .btn-primary button meets WCAG AA 4.5:1
    // (was 3.98:1 → now 5.05:1).  This is the default palette so
    // the change hardens accessibility for every new install.
    // primaryHover moved to violet-700 to preserve the "hover is
    // one shade darker" cue.
    light: { primary: "#7C3AED", primaryHover: "#6D28D9", pale1: "#F3EDFF", pale2: "#E5D3FF" },
