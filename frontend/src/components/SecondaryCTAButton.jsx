...
export default function SecondaryCTAButton({
  ...
  const base = `inline-flex items-center justify-center gap-2 rounded-lg bg-white text-[#2C2C2C] font-semibold border border-[#E5DDC5] hover:bg-[#FBFAF6] hover:border-[#6B46C1] hover:text-[#6B46C1] transition-colors ${SIZE_CLASSES[size] || SIZE_CLASSES.md} ${disabled ? "opacity-50 cursor-not-allowed" : ""} ${className}`;
