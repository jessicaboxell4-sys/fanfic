...
export default function PoweredByFanFicFare({ className = "" }) {
  return (
    <a
      ...
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FBFAF6] border border-[#E8E6E1] text-xs text-[#6B705C] hover:border-[#3A5A40]/40 hover:text-[#3A5A40] transition-colors ${className}`}
