...
export default function PrimaryCTAButton({
  ...
  const base = `inline-flex items-center justify-center gap-2 rounded-lg bg-[#6B46C1] text-white font-semibold hover:bg-[#553B96] transition-colors shadow-sm ${SIZE_CLASSES[size] || SIZE_CLASSES.md} ${disabled ? "opacity-50 cursor-not-allowed" : ""} ${className}`;
