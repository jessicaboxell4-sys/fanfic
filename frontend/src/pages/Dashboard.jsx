        ...
        <div className="mb-10">
          ...
          {conversions.converting > 0 ? (
            <Link
              ...
              className="inline-flex items-center gap-1.5 mt-3 ml-2 px-3 py-1 rounded-full text-xs font-medium border border-amber-300 bg-amber-50 text-amber-800 hover:bg-amber-100"
