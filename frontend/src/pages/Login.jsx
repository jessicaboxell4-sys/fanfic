...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid md:grid-cols-2 bg-paper">
      <SkipToContent />
      {/* Left panel: photo hero for md+.  We set `bg-[#2C2C2C]` on the
          wrapper so if the CDN image fails to load (rare — but was
          the reason the light-mode audit found the quote at 1.03:1
          contrast, iteration 71), the white overlay text still sits
          on a dark warm-brown fallback and stays readable. */}
      <div className="hidden md:block relative bg-[#2C2C2C]">
        <img
      ...
      <main id="main-content" tabIndex={-1} className="flex items-center justify-center p-8 md:p-16">
