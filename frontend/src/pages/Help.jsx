        ...
        <div className="grid md:grid-cols-1 gap-10">
          <article className="min-w-0 break-words">
            ...
            <Section id="uploads" icon={Upload} title="Uploading books">
              ...
              <p><strong>Batch size — please cap at 200 stories per drop.</strong> One batch job tops out at 200 files (the server rejects bigger uploads with a friendly &ldquo;Too many files in one batch&rdquo; error). If you&rsquo;ve got a 3,000-book library to migrate, that&rsquo;s 15 drops of 200 — sorry about the friction! It&rsquo;s the only ceiling we enforce, and it&rsquo;s purely to keep one user from monopolizing the antivirus scanner. Each batch processes in the background while you queue up the next one, so the wall-clock time stays low.</p>
