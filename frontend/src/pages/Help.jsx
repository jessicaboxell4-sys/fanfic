...
const FALLBACK_WHATS_NEW = {
  ...
  items: [
    ...
    { to: "/library/polish", label: "Auto-scan when you polish your library", desc: "— uploads are fast because the AV scan happens later. When you next polish your library (cleanup metadata, accept suggestions), ClamAV automatically sweeps your whole collection in the background — no separate prompts, no nagging." },
        ...
        <div className="grid md:grid-cols-1 gap-10">
          <article className="min-w-0 break-words">
            ...
            <Section id="antivirus" icon={Shield} title="Antivirus &amp; library safety">
              ...
              <ul>
                <li><strong>The flow</strong> — books arrive marked <em>&ldquo;unscanned&rdquo;</em>. When you next visit <Link to="/library/polish">Polish my library</Link> and apply suggestions, Shelfsort automatically runs ClamAV over your whole collection in the background and reports the result. No prompts, no nagging — it&apos;s just part of the cleanup step. You can also run a scan manually anytime from <Link to="/account/safety">Account → Library safety report</Link>.</li>
