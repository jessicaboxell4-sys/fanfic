        ...
        <div className="grid md:grid-cols-1 gap-10">
          <article className="min-w-0 break-words">
            ...
            <Section id="antivirus" icon={Shield} title="Antivirus &amp; library safety">
              ...
              <ul>
                <li><strong>The flow</strong> — books arrive marked <em>&ldquo;unscanned&rdquo;</em>. When you next visit <Link to="/library/polish">Polish my library</Link> and apply suggestions, Shelfsort automatically runs ClamAV over your whole collection in the background. The polish page shows a live <em>&ldquo;X / Y books scanned&rdquo;</em> counter with a progress bar so you can watch it sweep through — no toast spam, no nagging. <strong>Each sweep covers up to 500 books at a time</strong>; if your library is larger, polish again or use the manual rescan on <Link to="/account/safety">Account → Library safety report</Link> to cover the rest. You can also run a scan manually anytime from there.</li>
