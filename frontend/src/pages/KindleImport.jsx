...
export default function KindleImport() {
  ...
  return (
    ...
    >
      ...
      <header className="border-b border-[#E5DDC5] bg-white">
        <div className="max-w-3xl mx-auto px-6 md:px-8 py-5 flex items-center justify-between">
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm text-[#5B5F4D] hover:text-[#2C2C2C] min-h-[44px]"
          >
      ...
      <main id="main-content" tabIndex={-1} className="max-w-3xl mx-auto px-6 md:px-8 py-12 leading-relaxed flex-1 w-full">
