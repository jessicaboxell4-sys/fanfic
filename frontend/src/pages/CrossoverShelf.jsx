  ...
  return (
    <div className="min-h-screen bg-[#FAF6EE]">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#900] mb-2">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="relative flex-1 min-w-[260px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 rounded-lg border border-[#E5DDC5] bg-white text-sm focus:outline-none focus:border-[#900]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {filtered.map((f) => (
            <button
              ...
              className="shelf-card p-4 text-left hover:shadow-md transition border-[#900]/20 hover:border-[#900]"
            >
              <div className="flex items-start justify-between gap-2 mb-2">
                <span className="inline-flex items-center justify-center min-w-[22px] h-[22px] px-1.5 rounded-full bg-[#900] text-white text-xs font-bold leading-none">
                  ×{(f.parts || []).length}
                </span>
              ...
              <div className="flex flex-wrap gap-1.5">
                {(f.parts || []).map((p) => (
                  <span
                    key={p}
                    className="px-2 py-0.5 rounded-full text-[10px] font-medium bg-[#FDF3E1] text-[#900] border border-[#900]/20"
                  >
                    {p}
                  </span>
                ))}
              </div>
              <div className="flex items-center justify-end mt-3 text-xs text-[#900]">
