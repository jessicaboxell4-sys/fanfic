...
export default function PublicLibraryView() {
  ...
  if (needsLogin) {
    ...
    return (
      <div className="min-h-screen bg-paper">
        <SkipToContent />
        <Navbar />
        <main id="main-content" tabIndex={-1} className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
          <div
  ...
  return (
    <div className="min-h-screen bg-paper">
      <Navbar />
      <main id="main-content" tabIndex={-1} className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12 fade-in" data-testid="public-library-page">
