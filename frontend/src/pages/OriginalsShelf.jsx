      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {!loading && books.length > 0 && (
          ...
          >
            ...
            <label className="flex items-center gap-2 text-sm text-[#5B5F4D]">
              <input
                type="checkbox"
                checked={skipDups}
              ...
              >
                ...
                <div className="flex gap-2 flex-shrink-0">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg text-xs font-medium bg-white border border-[#E5DDC5] text-[#5B5F4D] hover:border-[var(--primary)] hover:text-[var(--primary)] inline-flex items-center gap-1.5"
                  >
