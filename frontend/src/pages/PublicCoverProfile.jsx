  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-paper">
        <SkipToContent />
        <Navbar />
        <main id="main-content" tabIndex={-1} className="max-w-5xl mx-auto px-6 py-14">
  ...
  if (notFound || !profile) {
    return (
      <div className="min-h-screen bg-paper">
        <SkipToContent />
        <Navbar />
        <main id="main-content" tabIndex={-1} className="max-w-5xl mx-auto px-6 py-14 text-center" data-testid="profile-not-found">
