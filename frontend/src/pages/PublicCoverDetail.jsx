...
export default function PublicCoverDetail() {
  ...
  if (loading) {
    return (
      <>
        <SkipToContent />
        <main id="main-content" tabIndex={-1} className="max-w-3xl mx-auto px-6 py-14" data-testid="cover-loading">
  ...
  if (notFound || !cover) {
    return (
      <>
        <SkipToContent />
        <main id="main-content" tabIndex={-1} className="max-w-3xl mx-auto px-6 py-14 text-center" data-testid="cover-not-found">
