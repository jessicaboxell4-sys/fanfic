...
def test_build_welcome_frontend_url_inlined_in_links():
    ...
    _, html, text = build_welcome_email(
        ...
        frontend_url="https://drift-check-live.preview.emergentagent.com",
    )
    assert "https://drift-check-live.preview.emergentagent.com/library" in html
    assert "https://drift-check-live.preview.emergentagent.com/library" in text
