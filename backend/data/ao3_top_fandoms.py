...
AO3_TOP_FANDOMS: Dict[str, List[str]] = {
    ...
    "Hannibal (TV)": ["hannibal tv", "hannigram", "will graham", "hannibal lecter", "bryan fuller", "jack crawford"],
    ...
    "Hannibal NBC": ["hannibal nbc", "will graham profiler", "hannibal lecter chesapeake"],
