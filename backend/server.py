...
from routes import root, auth, books, stats, series_categories, digest, year, smart_shelves, announcements, admin, chat, friends, invites, friend_library, suggestions, notifications  # noqa: F401
